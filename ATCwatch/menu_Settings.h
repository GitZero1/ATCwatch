...
class SettingsScreen : public Screen
{
  public:
    virtual void pre()
    {
      ...
      //lv_btn_set_fit2(pwr_btn,LV_FIT_MAX, LV_FIT_NONE); //set button width
      ...
      //set_custom_style(pwr_btn); //set button style
      ...
      lv_btn_set_fit2(reboot_btn,LV_FIT_MAX, LV_FIT_NONE); //set button width
      ...
      set_custom_style(reboot_btn);  //set button style
      ...
      lv_btn_set_fit2(bootload_btn,LV_FIT_MAX, LV_FIT_NONE); //set button width
      ...
      set_custom_style(bootload_btn);  //set button style
      ...
      lv_btn_set_fit2(theme_btn,LV_FIT_MAX, LV_FIT_NONE); //set button width
      ...
      set_custom_style(theme_btn); //set button style
      ...
      lv_btn_set_fit2(brightness_btn,LV_FIT_MAX, LV_FIT_NONE); //set button width
      ...
      set_custom_style(brightness_btn);  //set button style
    ...
    virtual void lv_event_class(lv_obj_t * object, lv_event_t event)
    {
      if (event == LV_EVENT_SHORT_CLICKED) {
        ...
        else if(object == pwr_btn){change_screen((Screen*)&themeScreen);}
